...
public class GetReadyManager : MonoBehaviour {
    ...
    public string RoomName = "Corridor";
    ...
    const string PromptLeader = "行走过程中照顾好组内成员是队长的责任！";
    const string PromptGroupMemeber = "行走过程中请紧跟自己的队长和组员，以免走丢！";
...
//                PlayerPrefs.SetInt("RightExit", dataObject.GetInt("RightExit"));
            ...
            case "HasStarted":
            {
                StatusText.text = "实验已经开始，请等待下次机会！";
                break;
            }
            default:
                break;
